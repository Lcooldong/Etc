...
// Timer 4 RGB PWM	
  ...
  HAL_TIMEx_PWMN_Start(&htim4, TIM_CHANNEL_3);
	...
	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 0);  //R
	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 0);  //G
	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 0);  //B
#endif
  ...
  {
    /* USER CODE END WHILE */
    printf("\n\r uwFrequency[%d]= 90,000,000 / uwDiffCaptur [%d]",uwFrequency,uwDiffCapture);
		HAL_Delay(500);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
static void MX_TIM5_Init(void)
{
  ...
  htim5.Instance = TIM5;
  htim5.Init.Prescaler = 90000;
  htim5.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim5.Init.Period = 9000;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  if(htim->Instance == TIM6)
	{
	   GPIOF->ODR =  GPIOF->ODR  ^0x0004;
	}
	
	if(htim->Instance == TIM7)
	{
	   GPIOF->ODR =  GPIOF->ODR  ^0x0002;
	}
}
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
  {
    if(uhCaptureIndex == 0)
    {
      ...
      uwIC1Value1 = HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_1);
      uhCaptureIndex = 1;
    }
    else if(uhCaptureIndex == 1)
    {
      /* Get the 2nd Input Capture value */
      uwIC1Value2 = HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_1); 
      ...
      else  /* (uwIC1Value2 <= uwIC1Value1) */
      {
        uwDiffCapture = ((0xFFFF - uwIC1Value1) + uwIC1Value2); 
      }

      uwFrequency = 90000000 / uwDiffCapture;
