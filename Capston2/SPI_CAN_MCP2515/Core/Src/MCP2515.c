...
{
	/* Set CANCTRL Register Configuration to Normal Mode*/
...
{
	/* Set CANCTRL Register Configuration to Sleep Mode*/
...
/* Transmit TxBuffer by RTS instruction */
